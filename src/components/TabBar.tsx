...
const TabBar: React.FC<TabBarTypes> = ({
  ...
  return (
    <div
      className={`flex p-1 gap-2 items-center duration-300 ease-in hover:bg-[#1d6d55] rounded-full w-4/5 cursor-pointer ${
        isActive === name.toLowerCase() ? "bg-[#1d6d55] font-bold" : ""
      }`}
